...
let imgDescriptions = [
  "Λάδι σε μουσαμά, 200 x 200 εκ. <br> ... <br><br> Αρ. Έργου: Π.641", 
  "Λάδι σε μουσαμά, 27 x 28 εκ. <br> ... <br><br> Αρ. Έργου: Π.574/5", 
  "Λάδι σε μουσαμά, 48 x 39 εκ. <br> ... <br><br> Αρ. Έργου: Π.618", 
  "Λάδι σε μουσαμά, 25,5 x 25,5 εκ. <br> ... <br><br> Αρ. Έργου: Π.574/4", 
  "Λάδι σε μουσαμά, 27,5 x 22,5 εκ. <br> ... <br><br> Αρ. Έργου: Π.574/3", 
  "Λάδι σε μουσαμά, 27 x 26,5 εκ. <br> ... <br><br> Αρ. Έργου: Π.574/1", 
  "Κιμωλία σε μαύρο χαρτί, 19,5 x 18,5 εκ. <br> ... <br><br> Αρ. Έργου: Π.559/4"
                     ];

let titles = ["Ιδού ο Νυμφίος έρχεται",
              "Ιδού ο Νυμφίος 1",
              "Νέος Αιών",
              "Ιδού ο Νυμφίος 2",
              "Ιδού ο Νυμφίος 3",
...
let Unlock = parseInt(localStorage.getItem('Complete5'), 10);
...
function preload() {
  ...
  for (let i = 1; i <= 7; i++) {
    images.push(loadImage("materials/levels/Lvl_B" + i + ".5.jpg"));
    ...
    loadImage("materials/images/Hint_1.png");
...
function setup() {
  ...
  Complete = createImg("materials/notifications/Completion5.png", "completeImg");
...
function artistInfo() {
  ...
  window.open("https://www.nationalgallery.gr/artist/gyzis-nikolaos/", "_blank");
}
...
function papirosImgClicked() {
  ...
  if (!hintBackground) {
    ...
    dynamicImage = createImg("materials/images/Hint_1.png", "dynamic-image");
